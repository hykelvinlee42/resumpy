...
def add_education(doc, resume_data):
    doc.append(UnsafeCommand("newcommand", "\\resumeEducation", options="2", extra_arguments=NoEscape(r"{}".format("""
        \\vspace{-1pt}\\item
    ...
    with doc.create(Section("EDUCATION")):
        ...
        for education in resume_data["education"]:
            doc.append(Command("resumeEducation", arguments=NoEscape(education["school"]), extra_arguments=NoEscape(education["duration"])))
