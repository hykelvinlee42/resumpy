...
def setup_document(doc, doc_type="resume"):
    ...
    doc.preamble.append(
        Command("renewcommand", NoEscape("\\headrulewidth"), extra_arguments="0pt")
    )
    doc.preamble.append(
        Command("renewcommand", NoEscape("\\footrulewidth"), extra_arguments="0pt")
    )
    ...
    if doc_type == "resume":
        doc.preamble.append(
            Command(
                "addtolength",
                NoEscape("\\oddsidemargin"),
                extra_arguments=NoEscape("-0.5in"),
            )
        )
        doc.preamble.append(
            Command(
                "addtolength",
                NoEscape("\\evensidemargin"),
                extra_arguments=NoEscape("0in"),
            )
        )
        doc.preamble.append(
            Command(
                "addtolength", NoEscape("\\textwidth"), extra_arguments=NoEscape("1in")
            )
        )
        ...
        doc.preamble.append(
            Command(
                "addtolength",
                NoEscape("\\oddsidemargin"),
                extra_arguments=NoEscape("-0.15in"),
            )
        )
        doc.preamble.append(
            Command(
                "addtolength",
                NoEscape("\\textwidth"),
                extra_arguments=NoEscape("0.05in"),
            )
        )
        doc.preamble.append(
            Command(
                "addtolength",
                NoEscape("\\marginparwidth"),
                extra_arguments=NoEscape("5in"),
            )
        )

    doc.preamble.append(
        Command(
            "addtolength", NoEscape("\\topmargin"), extra_arguments=NoEscape("-.5in")
        )
    )
    doc.preamble.append(
        Command(
            "addtolength", NoEscape("\\textheight"), extra_arguments=NoEscape("1.0in")
        )
    )
    ...
    doc.preamble.append(
        Command("setlength", NoEscape("\\tabcolsep"), extra_arguments="0in")
    )
    ...
    doc.preamble.append(
        UnsafeCommand(
            ...
            options=None,
            extra_arguments=NoEscape(
                r"{}".format("""$\\vcenter{\\hbox{\\small$\\bullet$}}$""")
            ),
        )
    )
    doc.preamble.append(
        UnsafeCommand(
            ...
            options=None,
            extra_arguments=NoEscape(
                r"{}".format("""\\begin{itemize}[leftmargin=0in, label={}]""")
            ),
        )
    )
    doc.preamble.append(
        UnsafeCommand(
            ...
            options=None,
            extra_arguments=NoEscape(r"{}".format("""\\end{itemize}""")),
        )
    )
    doc.preamble.append(
        UnsafeCommand(
            ...
            "\\resumeItemListStart",
            options=None,
            extra_arguments=NoEscape(r"{}".format("""\\begin{itemize}""")),
        )
    )
    doc.preamble.append(
        UnsafeCommand(
            ...
            "\\resumeItemListEnd",
            options=None,
            extra_arguments=NoEscape(r"{}".format("""\\end{itemize}\\vspace{0pt}""")),
        )
    )
