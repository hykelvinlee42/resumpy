...
def setup_document(doc):
    ...
    doc.preamble.append(
        NoEscape("\\def\\endbibenum{\\oldendbibenum\\vspace{-.6\\baselineskip}}")
    )
    doc.preamble.append(NoEscape("\\let\\oldendbibsection\\endbibsection"))
    doc.preamble.append(
        NoEscape("\\def\\endbibsection{\\oldendbibsection\\vspace{-.6\\baselineskip}}")
    )
    ...
    doc.preamble.append(
        Command(
            "setlength",
            arguments=NoEscape("\\footpageshift"),
    ...
    doc.preamble.append(
        Command(
            "newcommand",
            arguments=NoEscape("\\blankline"),
            extra_arguments=NoEscape("\\quad\\pagebreak[3]"),
        )
    )
    doc.preamble.append(
        Command(
            "newcommand",
            arguments=NoEscape("\\halfblankline"),
            extra_arguments=NoEscape(
                "\\quad\\vspace{-0.5\\baselineskip}\\pagebreak[3]"
            ),
        )
    )
